import style from "./TestimonalCard.module.css";
    ...
    <div className={style.Boxcontainer}>
      <div className={style.boxHead}>
        ...
        <div className={style.listBox}>
          ...
          >
            <g fill="currentColor">
              <path d="M3.53 3.53a.67.67 0 0 1 .94 0L8 7.06l3.53-3.53a.67.67 0 1 1 .94.94L8.94 8l3.53 3.53a.67.67 0 1 1-.94.94L8 8.94l-3.53 3.53a.67.67 0 1 1-.94-.94L7.06 8 3.53 4.47a.67.67 0 0 1 0-.94" />
            </g>
          </svg>
        </div>
      </div>
      ...
      <div className={style.boxBody}>
        <div className={style.testiomalcommentbox}>
          <p className={style.testiomalcomment}>{props.testimonal}</p>
        </div>

        <div className={style.testimonaluserinfo}>
          <img
            src={props.userimg}
            alt=""
            className={style.testimonaluserprofile}
          />
          <div className={style.testimonaluserbiobox}>
            <h1 className={style.testimonalusername}>{props.username}</h1>
            <h2 className={style.testimonaluserextrainfo}>{props.userdescription}</h2>
          </div>
        </div>
      </div>
    </div>
